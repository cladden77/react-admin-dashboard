...
const Sidebar = () => {
  ...
  const [ selected, setSelected] = useState("Dashboard"); // What page we are on
            ...
            {!isCollapsed && (
              <Box mb="10px">
                ...
                <Box textAlign="center">
                  <Typography variant="h3" color={colors.grey[100]} fontWeight="bold" sx={{ m: "10px 0 0 0" }}>Chris Ladden</Typography>
